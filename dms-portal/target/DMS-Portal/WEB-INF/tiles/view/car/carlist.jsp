		...
		<div class="col-lg-12">
			<div class="portlet">
				...
				<div class="portlet-header">
					...
					<div class="caption">
						<div class="caption">
							<a class="btn btn-success" title="Add New Car" href="<%=UrlConstants.CAR%>">Add
								New Car</a>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<table class="table table-striped table-bordered table-hover"
						...
						<tbody>
							<c:forEach items="${carDetails}" var="carVo"
								varStatus="loopcounter">
								<tr>
									<td><c:out value="${loopcounter.count}" /></td>
									<td><c:out value="${carVo.carType.carType}" /></td>
									<td><c:out value="${carVo.carName.carName}" /></td>
									<td><c:out value="${carVo.carNo}" /></td>
									<td><c:out value="${carVo.carModel }" /></td>
									<td><c:out value="${carVo.seatingCap}" /></td>
									<td align="center">
