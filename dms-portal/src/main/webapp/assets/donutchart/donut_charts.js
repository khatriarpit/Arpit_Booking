...
$(function () {
   ...
   /*---------------------
	...
	if($('#doughnutChart')[0]){
		...
		var firsttootip = $('#chart-line-1').attr('data-tooltip');
		var secondWidth = $('#chart-line-2').attr('data-width');
		var secondtootip = $('#chart-line-2').attr('data-tooltip');
...
if($('#doughnutChartsecond')[0]){
		// Get context with jQuery - using jQuery's .get() method.
		var doughnutChartCanvas = $("#doughnutChartsecond").get(0).getContext("2d");
		var firstWidth = $('#chart-line-3').attr('data-width');
		var firsttootip = $('#chart-line-3').attr('data-tooltip');
		var secondWidth = $('#chart-line-4').attr('data-width');
		var secondtootip = $('#chart-line-4').attr('data-tooltip');
		var thirdWidth = $('#chart-line-5').attr('data-width');
		var thirdtootip = $('#chart-line-5').attr('data-tooltip');
